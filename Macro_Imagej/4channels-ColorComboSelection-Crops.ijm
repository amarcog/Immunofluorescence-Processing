...
FIJI_ch4_ID = "C4-" + titlewoext + "-1" + extension;
...
FIJI_ch4_ID = "C4-" +titlewoext+ "-" +CropID+ "_Composite.tif";
...
selectWindow(""+titlewoext+"-"+CropID+"_MergeWO-"+name_ch4+".tif");height = getHeight();
run("Scale Bar...", "width="+scale_bar+" height="+height*0.02+" font=29 color=White background=None location=[Lower Right] hide");
saveAs("Tiff", ""+output+""+titlewoext+"-"+CropID+"_MergeWO-"+name_ch4+"-wscale.tif");
