...
run("Merge Channels...", "c2=["+FIJI_ch2_ID+"] c3=["+FIJI_ch3_ID+"] keep");
selectWindow("RGB");saveAs("Tiff", ""+output+""+titlewoext+"_MergeWO-"+name_ch1+".tif");

run("Merge Channels...", "c1=["+FIJI_ch1_ID+"] c3=["+FIJI_ch3_ID+"] keep");
...
run("Concatenate...", "  title=[Stack] image1=["+titlewoext+"_"+Color_ch1+"-"+name_ch1+".tif] image2=["+titlewoext+"_"+Color_ch2+"-"+name_ch2+".tif] image3=["+titlewoext+"_"+Color_ch3+"-"+name_ch3+".tif] image4=["+titlewoext+"_Merge-all-wscale.tif]");
