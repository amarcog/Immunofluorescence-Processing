...
run("Concatenate...", "  title=[Stack] image1=["+titlewoext+"-"+CropID+"_"+Color_ch1+"-"+name_ch1+".tif] image2=["+titlewoext+"-"+CropID+"_"+Color_ch2+"-"+name_ch2+".tif] image3=["+titlewoext+"-"+CropID+"_Merge-all-wscale.tif]");
run("Make Montage...", "columns=3 rows=1 first=1 last=4");
